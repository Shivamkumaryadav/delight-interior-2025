...
<template>
    ...
    <div class="bg-white max-w-l mt-16 rounded-lg p-4 border border-gray-200">
        ...
        <form @submit.prevent="store">
            ...
            <div class="space-y-1 flex-1 my-6">
                <Label for="name">Image</Label>
                <Input
                    type="file"
                    class="flex py-6 border border-gray-300 focus:broder-0 focus:ring-red-500"
            ...
            <div class="mt-6 flex justify-between gap-6">
                <NavigationLink
                    href="/admin/films"
                    class="hover:text-white text-center border border-red-500 cursor-pointer w-full text-gray-800 bg-white font-semibold py-2 px-4 rounded-md transition duration-300"
                    >Cancel</NavigationLink
                >
