    ...
    <div class="w-full rounded-xl relative">
        ...
        >
            <div class="text-start">
                ...
                <p class="text-sm">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Esse, laudantium doloremque, adipisci sequi magnam earum
                    exercitationem recusandae dolorum perspiciatis ab, tenetur
                    quam alias praesentium dignissimos officiis illum ea
                    assumenda sunt?
                </p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3">
        ...
        >
            ...
            <div class="flex flex-col gap-1">
                ...
                <p class="text-[#4e7397] text-sm font-normal leading-normal">
                    Our films come with a comprehensive warranty, ensuring your
                    peace of mind.
                </p>
            </div>
        </div>
        ...
        >
            ...
            <div class="flex flex-col gap-1">
                ...
                <p class="text-[#4e7397] text-sm font-normal leading-normal">
                    Our team of certified professionals guarantees a flawless
