<template>
    <AppLayout>
        ...
        <div class="w-full rounded-xl relative">
            <div
                class="aspect-[4/3] sm:aspect-[16/9] lg:aspect-[21/9] w-full overflow-hidden"
            >
                <img
            ...
            <!-- image overlay text -->
            <div
                class="absolute inset-0 flex justify-center items-end mb-5 md:mb-10 px-5 text-white z-32"
            >
                <div class="text-start ">
                    <h3 class="lg:text-3xl font-semibold mb-2">
                        Lorem, ipsum dolor sit amet consectetur adipisicing
                        elit. Esse,
                    </h3>
                    <p class="text-sm">
                        Lorem, ipsum dolor sit amet consectetur adipisicing
                        elit. Esse, laudantium doloremque, adipisci sequi magnam
                        earum exercitationem recusandae dolorum perspiciatis ab,
                        tenetur quam alias praesentium dignissimos officiis
                        illum ea assumenda sunt?
                    </p>
                </div>
            </div>
        </div>
        ...
        <section class="my-6">
            <div class="flex justify-between gap-5 items-center">
                <h3 class="text-xl font-semibold my-3">Our Films Types</h3>
                <div>
                    <Link href="/">View All</Link>
                </div>
            </div>
            <div class="grid  grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-5">
                <div>
                    <div
                        class="w-full h-20 aspect-square overflow-hidden rounded-xl"
                    >
                        <img
                    ...
                    <div class="my-2">
                        <h3 class="text-xs md:text-md font-[500]">Sun Control Film</h3>
                    </div>
                </div>
                <div>
                    <div
          ...
          <h2 class=" text-[22px] font-bold leading-tight tracking-[-0.015em] pb-3 pt-5">Why Choose SunGuard Films?</h2>
            <div class="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 ">
              <div class="flex flex-1 gap-3 rounded-lg border border-[#d0dbe7] bg-slate-50 p-4 flex-col">
                <div class="" data-icon="Shield" data-size="24px" data-weight="regular">
                ...
                <div class="flex flex-col gap-1">
                  <h2 class=" text-base font-bold leading-tight">Trusted Quality</h2>
                  <p class="text-[#4e7397] text-sm font-normal leading-normal">We use only the highest quality materials for lasting performance and satisfaction.</p>
                </div>
              </div>
              <div class="flex flex-1 gap-3 rounded-lg border border-[#d0dbe7] bg-slate-50 p-4 flex-col">
                <div class="" data-icon="Certificate" data-size="24px" data-weight="regular">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                    <path
                ...
                <div class="flex flex-col gap-1">
                  <h2 class=" text-base font-bold leading-tight">Comprehensive Warranty</h2>
                  <p class="text-[#4e7397] text-sm font-normal leading-normal">Our films come with a comprehensive warranty, ensuring your peace of mind.</p>
                </div>
              </div>
              <div class="flex flex-1 gap-3 rounded-lg border border-[#d0dbe7] bg-slate-50 p-4 flex-col">
                <div class="" data-icon="UsersThree" data-size="24px" data-weight="regular">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                    <path
                ...
                <div class="flex flex-col gap-1">
                  <h2 class=" text-base font-bold leading-tight">Expert Installation</h2>
                  <p class="text-[#4e7397] text-sm font-normal leading-normal">Our team of certified professionals guarantees a flawless installation every time.</p>
                </div>
              </div>
              <div class="flex flex-1 gap-3 rounded-lg border border-[#d0dbe7] bg-slate-50 p-4 flex-col">
                <div class="" data-icon="ClockCounterClockwise" data-size="24px" data-weight="regular">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                    <path
                ...
                <div class="flex flex-col gap-1">
                  <h2 class=" text-base font-bold leading-tight">Fast Turnaround</h2>
                  <p class="text-[#4e7397] text-sm font-normal leading-normal">We pride ourselves on efficient service, completing most installations quickly.</p>
                </div>
              </div>
            </div>
    </AppLayout>
