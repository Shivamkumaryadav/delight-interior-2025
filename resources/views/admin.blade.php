                  ...
                  <li class="item py-[11px] text-bgray-900 dark:text-white">
                    ...
                    >
                      <li>
                        <a
                          href="index.html"
                          class="text-md font-medium text-bgray-600 dark:text-bgray-50 hover:dark:text-success-300 transition-all py-1.5 inline-block hover:text-bgray-800"
                          >Dashboard Default</a
                        >
                      </li>
                      <li>
                    ...
                    <a href="messages.html">
                      <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2.5 items-center">
                          ...
                          <!--counter-->
                          <div
                            class="w-5 h-5 rounded-full bg-success-300 flex justify-center items-center"
                          >
...
<!-- Mirrored from spaceraceit.com/html/bankco/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Sep 2025 17:13:05 GMT -->
</html>
